...
//
// Ce code est utilisé dans le cadre du projet ZenthProject et est distribué par Signal Messenger, LLC.
// Nous tenons à exprimer notre gratitude pour leur contribution.
//
